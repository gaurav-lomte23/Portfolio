            ...
            {blogs.length > 0 && (
                <div
                    ...
                    <div className={styles.blogHeader}>
                        <p className={styles.blogEyebrow} style={{ color: theme.primary }}>
                            Curated reading
                        </p>
                        <h1 style={{ color: theme.primary }}>Featured Reads</h1>
                        <p className={styles.blogSubtext} style={{ color: theme.tertiary }}>
                            Three AI articles.
                        </p>
                    </div>
                        ...
                        {blogs.length > 3 && (
                            <div className={styles.blogViewAll}>
                                <Link href="/blog">
                                    ...
                                    hover:bg-[#C8922E] transition-colors">
                                        View All
                                        <HiArrowRight
